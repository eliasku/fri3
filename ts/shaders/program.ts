...
export interface Program {
    ...
    _uResolution?: WebGLUniformLocation;
    _uImage0?: WebGLUniformLocation;
    _aPosition: GLint;
    _aTexCoord: GLint;
    _aColorMul: GLint;
    _aColorAdd: GLint;
...
export const bindAttrib = (name: GLint, size: number, stride: number, offset: number, type: GLenum, norm: boolean) => {
