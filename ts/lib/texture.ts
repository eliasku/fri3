...
export const __setTextureData = (desc_ptr: Ptr<u8>): void => {
    ...
    texture._h = height;
    gl.bindTexture(GL.TEXTURE_2D, texture._texture);
    gl.texParameteri(GL.TEXTURE_2D, GL.TEXTURE_WRAP_S, wrap_s ? GL.REPEAT : GL.CLAMP_TO_EDGE);
    gl.texParameteri(GL.TEXTURE_2D, GL.TEXTURE_WRAP_T, wrap_t ? GL.REPEAT : GL.CLAMP_TO_EDGE);
